...
allowed_tools: ["Bash", "Write", "mcp__chrome-devtools__evaluate_script", "mcp__chrome-devtools__navigate_page", "mcp__chrome-devtools__wait_for", "mcp__chrome-devtools__take_snapshot"]
---
...
# ファイルパス: ~/.claude/projects/.../tool-results/mcp-chrome-devtools-evaluate_script-*.txt
"
```
...
# 場所: ~/.claude/projects/{project_id}/tool-results/mcp-chrome-devtools-evaluate_script-*.txt
results_dir = os.path.expanduser('~/.claude/projects/{project_id}/tool-results/')
...
```python
# JSONL パス: ~/.claude/projects/{project_id}/{session_id}.jsonl
